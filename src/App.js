  ...
  return (
    <div className="App">
      <div className="container">
        ...
        <ChatInput addNewHumanChatLogs={addNewHumanChatLogs} humanChatLogs={humanChatLogs} letter={letter} onClick={generateText} generatedText={data} aiChatLogs={aiChatLogs}></ChatInput>
